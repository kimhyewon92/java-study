...
//	변경후: {Tom=[전화번호=555-123-4567, 월급=4600000], John=[전화번호=123-456-7890, 월급=4100000], Emma=[전화번호=987-654-3210, 월급=2300000]}
	...
	public static void main(String[] args) {
		Map<String, Information> employees = new HashMap<>();
		Information info = new Information();
		
		employees.put("John", new Information("123-456-7890", 3800000));
		employees.put("Emma", new Information("987-654-3210", 2300000));
		employees.put("Tom", new Information("555-123-4567", 4600000));
		System.out.println("변경전: " + employees);
		
		// HashMap에 저장된 요소의 값을 수정하는 3가지 방법
		// 방법1: 기존 키에 새로운 값으로 덮어쓰기
		employees.put("John", new Information("123-456-7890", 4100000));
		
		// 방법2: 객체 내부 값 직접 변경
		employees.get("John").setSalary(4200000);
		
		// 방법3: Java 8 이상부터는 replace() 메소드 사용 가능
		// 키가 존재할 때만 값 교체, 키가 없으면 아무 동작 안함
		employees.replace("John", new Information("123-456-7890", 4100000));
		
		System.out.println("변경후: " + employees);
...
//		월급: 2300000
		...
		employees.get("Emma").setPhone("111-111-111");
		System.out.println("===== Emma의 정보 =====");
		System.out.println("전화번호: " + employees.get("Emma").getPhone());
		System.out.println("월급: " + employees.get("Emma").getSalary());
