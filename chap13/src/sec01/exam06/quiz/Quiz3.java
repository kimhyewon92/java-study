...
//	키: Mercury, 값: 수성(지름: 4879km, 공전주기: 0.24년)
	...
	public static void main(String[] args) {
		...
		Set<String> planetSet =  planet.keySet();
		
		for (String planetKey : planetSet) {
			Planet value = planet.get(planetKey);
			System.out.println("행성 이름: " + planetKey + "(" + value.getName() + "), 지름: " + value.getDiameter() + "km, 공전주기: " + value.getPeriod() + "년");
		}
