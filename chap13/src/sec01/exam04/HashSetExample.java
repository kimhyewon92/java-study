...
//		System.out.println("교집합: " + class1);
		...
		// 원본 변경을 원하지 않으면, 새 집합을 만들고 addAll 해서 해당 집합으로 사용하기
		...
		// 필요하면 정렬된 순서를 유지하는 Set으로 다시 만들기 (LinkedHashSet 으로)
		...
		// 필요 시 다시 List로 변환
		List<String> deduplicatedList = new ArrayList<String>(javaClass);
