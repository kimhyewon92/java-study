...
//	전체 주문 취소: []
	...
	public static void main(String[] args) {
		...
		menu.add(new Food("샐러드", 14000));
		menu.add(new Food("치킨", 23000));
		menu.add(new Food("치킨", 50000));
		
		menu.remove(new Food("치킨", 50000));
		System.out.println("5만원 치킨 취소: " + menu);
		
		menu.clear();
		System.out.println("전체 주문 취소: " + menu);
	}
