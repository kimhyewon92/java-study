...
public class StringGetBytesExample {
	...
	public static void main(String[] args) {
		...
		try {
			// 특정 문자셋으로 인코딩
			byte[] bytes2 = str.getBytes("EUC-KR"); // 한글완성형인데 잘 안쓰임 보통 UTF-8 사용
			System.out.println("bytes2.length: " + bytes2.length); // 10
			// 특정 문자셋으로 디코딩
			String str2 = new String(bytes2, "EUC-KR"); // 인코딩 시 사용한 문자셋과 동일하게 넣어줘야함 ..아니면 깨져서 나옴
			...
			// 특정 문자셋으로 디코딩
			String str3 = new String(bytes3, "UTF-8"); // UTF-8은 기본값이어서 써주지 않아도됨
