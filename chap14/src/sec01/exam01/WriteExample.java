...
public class WriteExample {
	...
	public static void main(String[] args) throws Exception {
		...
		// FileOutputStream 하위타입, OutputStream 상위타입 입력시 다형성 활용
		OutputStream os = new FileOutputStream("C:/TempTest/test1.db"); // 바이트를 파일에 출력해서 저장하는 기능을 가짐
//		OutputStream os = new FileOutputStream("C:/TempTest/test1.txt"); // 한글 문자는 3바이트씩으로 InputStream으로 받을시 문자가 깨짐..
...
//		char c = '다';
		...
		// 버퍼(임시 저장 공간)에 쌓임
		// 버퍼: 물건을 잠시 담아두는 창고 ..출력횟수를 줄여줘서 성능이 좋아짐
		// 출력 스트림: 물건을 외부로 보내는 트럭
		
		// 반드시 writer() 후에 flush() 수행
...
//		try (OutputStream os2 = new FileOutputStream("C:/TempTest/test1.db")) {
//			os2.write(a);
//			os2.write(b);
//			os2.write(c);
//		} catch (Exception e) {
