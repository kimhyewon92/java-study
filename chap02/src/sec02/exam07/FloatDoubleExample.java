...
//		float var1 = 3.14; // 자바 컴파일러는 실수 리터럴을 기본적으로 double 타입으로 간주,해석하여 뒤에 f,F 붙어줘야함
		...
		System.out.println(var4); // 0.12345679 끝은 반올림처리
		System.out.println(var5); // 0.12345678901234568 끝은 반올림처리
